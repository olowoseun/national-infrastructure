...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('asset', 'AssetsController', ['except' => ['show']]);
    
    Route::resource('assets', 'AssetsController');
    Route::get('/asset-subclass/{id}', 'AssetsController@asset_subclass');
    Route::get('/asset-category/{id}', 'AssetsController@asset_category');
    Route::get('/geopolitical-zones', 'AssetsController@geopolitical_zones');
    Route::get('/states/{id}', 'AssetsController@states');
    Route::get('/lgas/{id}', 'AssetsController@lgas');
