            ...
            <form action="{{ route('assets.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" 
                        name="value-2012" id="value-2012" placeholder="Enter value 2012">
                </div>
                <div class="form-group">
                    <label for="value-2013">Value 2013</label>
                    <input type="text" class="form-control" 
                        name="value-2013" id="value-2013" placeholder="Enter value 2013">
                </div>
                <div class="form-group">
                    <label for="value-2014">Value 2014</label>
                    <input type="text" class="form-control" 
                        name="value-2014" id="value-2014" placeholder="Enter value 2014">
                </div>
                <div class="form-group">
                    <label for="value-2015">Value 2015</label>
                    <input type="text" class="form-control" 
                        name="value-2015" id="value-2015" placeholder="Enter value 2015">
                </div>
                <div class="form-group">
                    <label for="value-2016">Value 2016</label>
                    <input type="text" class="form-control" 
                        name="value-2016" id="value-2016" placeholder="Enter value 2016">
                </div>
                <div class="form-group">
                    <label for="value-2017">Value 2017</label>
                    <input type="text" class="form-control" 
                        name="value-2017" id="value-2017" placeholder="Enter value 2017">
                </div>
                <div class="form-group">
                    <label for="value-2018">Value 2018</label>
                    <input type="text" class="form-control" 
                        name="value-2018" id="value-2018" placeholder="Enter value 2018">
                </div>
                <div class="form-group">
                    <label for="value-2019">Value 2019</label>
                    <input type="text" class="form-control" 
                        name="value-2019" id="value-2019" placeholder="Enter value 2019">
                </div>
                <div class="form-group">
