    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script>
          $(document).ready(function () {
            ...
            $('#asset-class').on('change', function() {

            var asset_class_id = $(this).val();
            //console.log(asset_class_id);
            if(asset_class_id) {
                $.ajax({
                    url: '/asset-subclass/' + asset_class_id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        //console.log(data);                        
                        if(data) {                          
                            $('#asset-subclass').empty();
                            
                            $('#asset-subclass')
                            .append('<option>Select Asset Subclass</option>');                            
            ...
            $('#asset-subclass').on('change', function() {
            var asset_subclass_id = $(this).val();
            // console.log(asset_subclass_id);
            if(asset_subclass_id) {
                $.ajax({
                    url: '/asset-category/' + asset_subclass_id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        // console.log(data);
                        if(data) {
                            $('#asset-category').empty();
                            $('#asset-category')
                              .append('<option>Select Asset Category</option>');
                            $.each(data, function(key, value) {
                            $('#asset-category')
                                .append('<option value="' + key + '">' + value + '</option');
                            });
            ...
            $('#geopolitical-zone').on('change', function() {
            var geopolitical_zone_id = $(this).val();
            console.log(geopolitical_zone_id);
            if(geopolitical_zone_id) {
                $.ajax({
                    url: '/states/' + geopolitical_zone_id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        //console.log(data);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data) {
                            $('#lga').empty();
                            $('#lga')
                                .append('<option>Select LGA</option>');
                            $.each(data, function(key, value) {
                            $('#lga')
                                .append('<option value="' + key + '">' + value + '</option');
                            });
